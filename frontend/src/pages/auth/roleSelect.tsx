  ...
  return (
    <div className="min-h-screen bg-white px-6 py-16 flex flex-col items-center">
      <div className="max-w-3xl text-center mb-12">
        <h1 className="text-3xl font-bold text-indigo-500 dark:text-indigo-500 mb-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 w-full max-w-4xl">
        <SingleCard
          image="https://cdn.tailgrids.com/assets/images/core-components/cards/image-02.jpg"
