...
exports.AdminDisputeMapper = void 0;
class AdminDisputeMapper {
    static map(dispute) {
        return {
            ...
            job: dispute.jobId
                ...
                : null,
            milestoneId: dispute.milestoneId?._id?.toString() ||
    ...
    static mapList(disputes) {
        return disputes.map(AdminDisputeMapper.toListDto);
    }
}
exports.AdminDisputeMapper = AdminDisputeMapper;
